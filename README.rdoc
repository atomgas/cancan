...
=== Model-less Controller Authorization

If you have a controller that has no associated model you can use +cancan_authorize+ to secure your controller. 
...
Do define an ability for this controller, use a symbol in the Ability class:
